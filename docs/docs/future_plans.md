...
- [~] Use OpenAPI for the API contract (SpringDoc OpenAPI config exists, endpoint annotations incomplete).
- [ ] Expand test coverage (Vitest + Playwright + Storybook configured, more tests needed).
